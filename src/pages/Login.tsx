    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-slide-down">
          ...
          <p className="text-muted-foreground">AI-Powered Stock Sentiment Analysis</p>
        </div>
        ...
        <div className="glass-card p-8 animate-scale-in" style={{ animationDelay: '0.2s' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 h-12 bg-secondary/50 border-border/50 rounded-xl focus:ring-2 focus:ring-primary/50"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-12 pr-12 h-12 bg-secondary/50 border-border/50 rounded-xl focus:ring-2 focus:ring-primary/50"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 rounded-xl bg-gradient-to-r from-primary to-accent hover:opacity-90 text-primary-foreground font-semibold text-lg gap-2 transition-all duration-300"
            >
              {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="h-12 rounded-xl border-border/50 hover:bg-secondary">
